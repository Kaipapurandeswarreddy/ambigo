          ...
          >
            ...
            <div className="ambigo-card p-6 flex gap-5 flex-shrink-0 snap-center w-10/12 max-w-[320px] md:w-full md:max-w-none">
              <div className="w-14 h-14 shrink-0 bg-orange-50 rounded-2xl p-3 flex items-center justify-center">
                <svg className="w-8 h-8 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
              </div>
              <div>
            ...
            <div className="ambigo-card p-6 flex gap-5 flex-shrink-0 snap-center w-10/12 max-w-[320px] md:w-full md:max-w-none">
              <div className="w-14 h-14 shrink-0 bg-orange-50 rounded-2xl p-3 flex items-center justify-center">
                <svg className="w-8 h-8 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
              </div>
              <div>
            ...
            <div className="ambigo-card p-6 flex gap-5 flex-shrink-0 snap-center w-10/12 max-w-[320px] md:w-full md:max-w-none">
              <div className="w-14 h-14 shrink-0 bg-orange-50 rounded-2xl p-3 flex items-center justify-center">
                <svg className="w-8 h-8 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
              </div>
              <div>
