      ...
      <div className="ambigo-footer__grid max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <div className="flex flex-row flex-nowrap items-center gap-4">
            <a href="https://www.instagram.com/ambigo.in?igsh=NGkyeTZtMnRyc3M%3D&utm_source=qr" target="_blank" rel="noreferrer" className="ambigo-social-btn w-10 h-10 rounded-full flex items-center justify-center text-white transition-colors shadow-md">
            ...
            <a href="https://www.linkedin.com/in/ambigo-in-550251361?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noreferrer" className="ambigo-social-btn w-10 h-10 rounded-full flex items-center justify-center text-white transition-colors shadow-md">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>
            <a href="https://wa.me/message/QV7OWKT2Y36NK1" target="_blank" rel="noreferrer" className="ambigo-social-btn w-10 h-10 rounded-full flex items-center justify-center text-white transition-colors shadow-md">
